...
Evas_Object *RecipientsPanelView::mbeCreate(Evas_Object *parent)
{
  ...
  // evas_object_smart_callback_add(mbe, "item,added", SMART_CALLBACK(RecipientsPanelView, onItemAdded), this);
    evas_object_smart_callback_add(mbe, "item,selected", SMART_CALLBACK(RecipientsPanelView, onItemSelected), this);
    evas_object_smart_callback_add(mbe, "item,deleted", SMART_CALLBACK(RecipientsPanelView, onItemDeleted), this);
    evas_object_smart_callback_add(mbe, "item,clicked", SMART_CALLBACK(RecipientsPanelView, onItemClicked), this);

    evas_object_smart_callback_add(mbe, "focused", SMART_CALLBACK(RecipientsPanelView, onMbeFocused), this);
    evas_object_smart_callback_add(mbe, "clicked", SMART_CALLBACK(RecipientsPanelView, onMbeClicked), this);
    evas_object_smart_callback_add(mbe, "unfocused", SMART_CALLBACK(RecipientsPanelView, onMbeUnfocused), this);
...
{
    Evas_Object *m_pEntry = elm_entry_add(parent);
