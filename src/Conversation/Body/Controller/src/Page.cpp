...
void Page::addVideo(const std::string &videoFilePath)
{
    ...
    if(!thumbFilePath.empty())
    {
        ...
        static_cast<BodyView&>(m_Body).addVideo(*this, videoFilePath, fileSize, thumbFilePath);
    }
}
...
void Page::addImage(const std::string &filePath)
{
    ...
    if(!newFilePath.empty())
    {
        ...
        static_cast<BodyView&>(m_Body).addImage(*this, newFilePath, fileSize);
    }
}
...
void Page::addSound(const std::string &filePath, const std::string &fileName)
{
    ...
    if(!newFilePath.empty())
    {
        ...
        static_cast<BodyView&>(m_Body).addSound(*this, newFilePath, fileSize, newFileName);
    }
}
