...
SaveAttachmentsPopup::SaveAttachmentsPopup(App &app, MessageMms &mms)
...
void SaveAttachmentsPopup::create()
{
...
void SaveAttachmentsPopup::fillList()
{
    const MsgPageList &pageList = m_MsgMms.getPageList();
    ...
    const MsgAttachmentList &attachmentList = m_MsgMms.getAttachmentList();
