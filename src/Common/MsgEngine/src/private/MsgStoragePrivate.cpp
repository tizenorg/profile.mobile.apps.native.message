...
void MsgStoragePrivate::onStorageUpdate(MsgIdList msgId)
{
    //TODO
}

void MsgStoragePrivate::onStorageInsert(MsgIdList msgId)
{
...
void MsgStoragePrivate::onStorageDelete(MsgIdList msgId)
{
    for(auto listener: m_Listeners)
    {
        listener->onMsgStorageChange();
...
void MsgStoragePrivate::onStorageContact(MsgIdList msgId)
{
    //TODO
}
