...
namespace Msg
{
    ...
    class ContactManager
    {
        ...
        public:
             ...
             */
            ContactPersonNumber getContactPerson(const std::string &number) const;
             ...
             *@return       ContactPersonNumber
             */
            ContactPersonNumber getContactPerson(int phoneId) const;
        ...
        private:
             ...
             */
            ContactPersonNumber getContactPerson(contacts_filter_h filter) const;
