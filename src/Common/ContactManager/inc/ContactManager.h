...
{
    /*
     *@brief        interface that work with ContactManager and is a listener on contact database
     */
    ...
    class IContactDbChangeListener
    {
        public:
            ...
            /*
             *@brief        function that change contacts information when contactChangedCb
                              was called.
             */
