...
#include <algorithm>
 ...
 namespace Msg
 {
    ...
    ContactPersonNumber ContactManager::getContactPersonByPhoneId(int phoneNumId) const
    {
        contacts_filter_h filter = nullptr;
        ...
        return getContactPersonByFilter(filter);
    }
    ...
    ContactPersonNumber ContactManager::getContactPersonByFilter(contacts_filter_h filter) const
    {
        contacts_query_h query = nullptr;
        contacts_list_h list = nullptr;
