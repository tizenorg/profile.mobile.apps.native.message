...
namespace Msg
{
        ...
        : public AppControlCommand
    {
        public:
            ...
            {
                ComposeUnknownType,
                ComposeType, /** APP_CONTROL_OPERATION_COMPOSE */
                ShareType, /** APP_CONTROL_OPERATION_SHARE */
                MultiShareType, /** APP_CONTROL_OPERATION_MULTI_SHARE */
                ShareTextType /** APP_CONTROL_OPERATION_SHARE_TEXT */
            };
